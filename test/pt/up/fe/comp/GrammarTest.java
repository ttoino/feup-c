...
public class GrammarTest {
    ...
    private static final String IMPORT = "import_statement";
    private static final String MAIN_METHOD = "method_declaration";
    private static final String INSTANCE_METHOD = "method_declaration";
